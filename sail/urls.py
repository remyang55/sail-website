...
urlpatterns = [
    ...
    path('my-courses/', courses_views.student_courses, name="student-courses"),

    path('login/', auth_views.LoginView.as_view(template_name='users/login.html', redirect_authenticated_user=True, extra_context={'title':'Login'}), name='users-login'),
